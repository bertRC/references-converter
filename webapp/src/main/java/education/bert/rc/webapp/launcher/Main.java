...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        File webContentFolder = new File(root.getAbsolutePath(), "src/main/content/");
        ...
        ctx.getServletContext().setAttribute("analyzer", new Analyzer());
        ctx.getServletContext().setAttribute("templateCollection", new TemplateCollection());
